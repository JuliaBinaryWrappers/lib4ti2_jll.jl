# Autogenerated wrapper script for lib4ti2_jll for x86_64-w64-mingw32-cxx11
...
const lib4ti2int32_splitpath = ["bin", "lib4ti2int32-0.dll"]
...
const lib4ti2int32 = "lib4ti2int32-0.dll"


# Relative path to `ppi`
const ppi_splitpath = ["bin", "ppi.exe"]
...
const zsolve_splitpath = ["bin", "zsolve.exe"]
...
const exe4ti2int64_splitpath = ["bin", "4ti2int64.exe"]
...
const exe4ti2gmp_splitpath = ["bin", "4ti2gmp.exe"]
...
const genmodel_splitpath = ["bin", "genmodel.exe"]
...
const exe4ti2int32_splitpath = ["bin", "4ti2int32.exe"]
...
const lib4ti2int64_splitpath = ["bin", "lib4ti2int64-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const lib4ti2int64 = "lib4ti2int64-0.dll"


# Relative path to `libzsolve`
const libzsolve_splitpath = ["bin", "libzsolve-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libzsolve = "libzsolve-0.dll"
...
const lib4ti2_splitpath = ["bin", "lib4ti2gmp-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const lib4ti2 = "lib4ti2gmp-0.dll"


# Relative path to `gensymm`
const gensymm_splitpath = ["bin", "gensymm.exe"]
...
const output_splitpath = ["bin", "output.exe"]
