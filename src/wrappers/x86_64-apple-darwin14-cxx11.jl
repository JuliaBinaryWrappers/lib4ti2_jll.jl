# Autogenerated wrapper script for lib4ti2_jll for x86_64-apple-darwin14-cxx11
...
const lib4ti2int64_splitpath = ["lib", "lib4ti2int64.0.dylib"]
...
const lib4ti2int64 = "@rpath/lib4ti2int64.0.dylib"
...
const lib4ti2int32_splitpath = ["lib", "lib4ti2int32.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const lib4ti2int32 = "@rpath/lib4ti2int32.0.dylib"


# Relative path to `lib4ti2`
const lib4ti2_splitpath = ["lib", "lib4ti2gmp.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const lib4ti2 = "@rpath/lib4ti2gmp.0.dylib"
...
const libzsolve_splitpath = ["lib", "libzsolve.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libzsolve = "@rpath/libzsolve.0.dylib"
