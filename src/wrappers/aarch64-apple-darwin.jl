# Autogenerated wrapper script for lib4ti2_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(lib4ti2, "@rpath/lib4ti2gmp.0.dylib")
JLLWrappers.@declare_library_product(lib4ti2int32, "@rpath/lib4ti2int32.0.dylib")
JLLWrappers.@declare_library_product(lib4ti2int64, "@rpath/lib4ti2int64.0.dylib")
JLLWrappers.@declare_library_product(libzsolve, "@rpath/libzsolve.0.dylib")
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        lib4ti2,
        "lib/lib4ti2gmp.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        lib4ti2int32,
        "lib/lib4ti2int32.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        lib4ti2int64,
        "lib/lib4ti2int64.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libzsolve,
        "lib/libzsolve.0.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
