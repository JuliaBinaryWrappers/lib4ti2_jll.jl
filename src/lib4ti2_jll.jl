...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import lib4ti2_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1493ae25-0f90-5c0e-a06c-8c5077d6d66f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "lib4ti2", artifacts_toml) for e in artifacts["lib4ti2"]]
...
if best_platform === nothing
    @debug("Unable to load lib4ti2; unsupported platform $(triplet(platform_key_abi()))")
else
